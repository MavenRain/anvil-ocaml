...
(* (name, source) pairs - the k3-strengthened identity for the two
   disjointness guards below (P17 §7), via the shared {!Pair_guard}
   (BUILD-SPEC-P18 section 6 D2: the four byte-identical local copies
   extracted; assertions below byte-unchanged). *)
